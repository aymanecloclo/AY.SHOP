...
var F = (c, n) => {
  for (var i in n || (n = {})) e3.call(n, i) && u2(c, i, n[i]);
  if (k1) for (var i of k1(n)) t3.call(n, i) && u2(c, i, n[i]);
  return c;
};
var k = (c, n) => n0(c, i0(n));
var O1 = (c, n) => {
  var i = {};
  for (var s in c) e3.call(c, s) && n.indexOf(s) < 0 && (i[s] = c[s]);
  if (c != null && k1) for (var s of k1(c)) n.indexOf(s) < 0 && t3.call(c, s) && (i[s] = c[s]);
  return i;
};
...
var r0 = (() => {
  ...
  return function(i = {}) {
    ...
    function S2(e) {
      if (e == h1 && C1) return new Uint8Array(C1);
    ...
    var o1 = {}, n1 = {}, S1 = {}, f1, Q = (e, t, r) => {
      function a(l) {
        if (l = r(l), l.length !== e.length) throw new f1("Mismatched type converter count");
        for (var p4 = 0; p4 < e.length; ++p4) H2(e[p4], l[p4]);
      }
      e.forEach((l) => S1[l] = t);
      var o = Array(t.length), u = [], h = 0;
      t.forEach((l, p4) => {
        n1.hasOwnProperty(l) ? o[p4] = n1[l] : (u.push(l), o1.hasOwnProperty(l) || (o1[l] = []), o1[l].push(() => {
          o[p4] = n1[l], ++h, h === u.length && a(o);
        }));
      }), u.length === 0 && a(o);
    }, R2, D = (e) => {
      for (var t = ""; x[e]; ) t += R2[x[e++]];
      return t;
    }, y;
    function _3(e, t, r = {}) {
      var a = t.name;
    ...
    var J1 = (e) => {
      ...
      for (; e.Aa; ) t = e.Ka(t), e = e.Aa;
      return g3[t];
    }, T1 = (e, t) => {
      if (!t.xa || !t.wa) throw new f1("makeClassHandle requires ptr and ptrType");
      if (!!t.Ba != !!t.za) throw new f1("Both smartPtrType and smartPtr must be specified");
    ...
    var _1 = (e, t) => Object.defineProperty(t, "name", { value: e }), z2 = (e, t, r) => {
      if (e[t].ya === void 0) {
        var a = e[t];
        e[t] = function(...o) {
          if (!e[t].ya.hasOwnProperty(o.length)) throw new y(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${e[t].ya})!`);
          return e[t].ya[o.length].apply(this, o);
        }, e[t].ya = [], e[t].ya[a.Ha] = a;
      }
    }, q1 = (e, t, r) => {
      if (d.hasOwnProperty(e)) {
        if (r === void 0 || d[e].ya !== void 0 && d[e].ya[r] !== void 0) throw new y(`Cannot register public name '${e}' twice`);
        if (z2(d, e, e), d[e].ya.hasOwnProperty(r)) throw new y(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
        d[e].ya[r] = t;
      } else d[e] = t, d[e].Ha = r;
    }, b3 = (e) => {
    ...
    var K1 = (e, t, r) => {
      for (; t !== r; ) {
        if (!t.Ka) throw new y(`Expected null or instance of ${r.name}, got an instance of ${t.name}`);
        e = t.Ka(e), t = t.Aa;
      }
      return e;
    };
    function C3(e, t) {
      if (t === null) {
        if (this.Na) throw new y(`null is not a valid ${this.name}`);
        return 0;
      }
      if (!t.ua) throw new y(`Cannot pass "${n2(t)}" as a ${this.name}`);
      if (!t.ua.wa) throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
    ...
    function M3(e, t) {
      ...
      if (!t || !t.ua) throw new y(`Cannot pass "${n2(t)}" as a ${this.name}`);
      if (!t.ua.wa) throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.La && t.ua.xa.La) throw new y(`Cannot convert argument of type ${t.ua.Ba ? t.ua.Ba.name : t.ua.xa.name} to parameter type ${this.name}`);
      if (r = K1(t.ua.wa, t.ua.xa.va, this.va), this.Ma) {
        if (t.ua.za === void 0) throw new y("Passing raw pointer to smart pointer is illegal");
        switch (this.ib) {
          case 0:
            if (t.ua.Ba === this) r = t.ua.za;
            else throw new y(`Cannot convert argument of type ${t.ua.Ba ? t.ua.Ba.name : t.ua.xa.name} to parameter type ${this.name}`);
            break;
          case 1:
            r = t.ua.za;
            break;
    ...
    function E3(e, t) {
      ...
      if (!t.ua) throw new y(`Cannot pass "${n2(t)}" as a ${this.name}`);
      if (!t.ua.wa) throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (t.ua.xa.La) throw new y(`Cannot convert argument of type ${t.ua.xa.name} to parameter type ${this.name}`);
      return K1(t.ua.wa, t.ua.xa.va, this.va);
    }
    function g1(e, t, r, a, o, u, h, l, p4, v, f) {
      this.name = e, this.va = t, this.Na = r, this.La = a, this.Ma = o, this.bb = u, this.ib = h, this.Sa = l, this.Oa = p4, this.eb = v, this.Ea = f, o || t.Aa !== void 0 ? this.toWireType = M3 : (this.toWireType = a ? C3 : E3, this.Da = null);
    }
    var W2 = (e, t, r) => {
      if (!d.hasOwnProperty(e)) throw new f1("Replacing nonexistent public symbol");
    ...
    function S3(e) {
      for (var t = 1; t < e.length; ++t) if (e[t] !== null && e[t].Da === void 0) return true;
      return false;
    }
    function X1(e, t, r, a, o) {
      var u = t.length;
      if (2 > u) throw new y("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var h = t[1] !== null && r !== null, l = S3(t), p4 = t[0].name !== "void", v = u - 2, f = Array(v), w = [], L = [];
      return _1(e, function(...U) {
        if (L.length = 0, w.length = h ? 2 : 1, w[0] = o, h) {
          var I = t[1].toWireType(L, this);
          w[1] = I;
        }
        for (var T = 0; T < v; ++T) f[T] = t[T + 2].toWireType(L, U[T]), w.push(f[T]);
        if (U = a(...w), l) V1(L);
        else for (T = h ? 1 : 2; T < t.length; T++) {
          var N = T === 1 ? I : f[T - 2];
          t[T].Da !== null && t[T].Da(N);
        }
        return I = p4 ? t[0].fromWireType(U) : void 0, I;
      });
    }
    var B2 = (e) => {
      e = e.trim();
      ...
      var r = n1[e];
      if (r === void 0) throw e = `${t} has unknown type ${U2(e)}`, new y(e);
      return r;
    }, n2 = (e) => {
    ...
    }, A3 = Object.assign({ optional: true }, j2), H22 = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, R3 = (e, t) => {
      for (var r = e >> 1, a = r + t / 2; !(r >= a) && u1[r]; ) ++r;
      if (r <<= 1, 32 < r - e && H22) return H22.decode(x.subarray(e, r));
      for (r = "", a = 0; !(a >= t / 2); ++a) {
        var o = a1[e + 2 * a >> 1];
        if (o == 0) break;
      ...
      if (!(e instanceof x2 || e == "unwind")) throw e;
    }, V2 = (e) => {
      var t;
    ...
    for (var q22 = Array(256), R1 = 0; 256 > R1; ++R1) q22[R1] = String.fromCharCode(R1);
    R2 = q22, y = d.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Object.assign(x1.prototype, { isAliasOf: function(e) {
      if (!(this instanceof x1 && e instanceof x1)) return false;
      var t = this.ua.xa.va, r = this.ua.wa;
      e.ua = e.ua;
      var a = e.ua.xa.va;
      for (e = e.ua.wa; t.Aa; ) r = t.Ka(r), t = t.Aa;
      for (; a.Aa; ) e = a.Ka(e), a = a.Aa;
      return t === a && r === e;
    }, clone: function() {
      if (this.ua.wa || J1(this), this.ua.Ja) return this.ua.count.value += 1, this;
      ...
      if (this.ua.wa || J1(this), this.ua.Ia && !this.ua.Ja) throw new y("Object already scheduled for deletion");
      D2(this);
      var e = this.ua;
      ...
      var r = this.Xa(e);
      if (!r) return this.Qa(e), null;
      var a = y3(this.va, r);
      if (a !== void 0) return a.ua.count.value === 0 ? (a.ua.wa = r, a.ua.za = e, a.clone()) : (a = a.clone(), this.Qa(e), a);
      if (a = this.va.Wa(r), a = O2[a], !a) return t.call(this);
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var V3 = { c: (e, t, r, a) => P1(`Assertion failed: ${e ? c1(x, e) : ""}, at: ` + [t ? t ? c1(x, t) : "" : "unknown filename", r, a ? a ? c1(x, a) : "" : "unknown function"]), m: (e, t, r) => {
      var a = new f3(e);
      throw E[a.wa + 16 >> 2] = 0, E[a.wa + 4 >> 2] = t, E[a.wa + 8 >> 2] = r, A22 = e, A22;
    }, M: () => {
    }, J: () => {
    }, K: () => {
    }, P: function() {
      ...
      Q([e], u, (h) => {
        var l = {};
        return o.forEach((p4, v) => {
          var f = h[v], w = p4.Ya, L = p4.Za, U = h[v + o.length], I = p4.fb, T = p4.hb;
          l[p4.Va] = { read: (N) => f.fromWireType(w(L, N)), write: (N, w1) => {
            var B = [];
            I(T, N, U.toWireType(B, w1)), V1(B);
          } };
        }), [{ name: t.name, fromWireType: (p4) => {
          var v = {}, f;
          for (f in l) v[f] = l[f].read(p4);
          return a(p4), v;
        }, toWireType: (p4, v) => {
          for (var f in l) if (!(f in v)) throw new TypeError(`Missing field: "${f}"`);
          var w = r();
          for (f in l) l[f].write(w, v[f]);
          return p4 !== null && p4.push(a, w), w;
        }, Ca: 8, readValueFromPointer: v1, Da: a }];
      });
    }, C: () => {
    }, W: (e, t, r, a) => {
      t = D(t), H2(e, { name: t, fromWireType: function(o) {
        return !!o;
    ...
    }, r: (e, t, r, a, o, u, h, l, p4, v, f, w, L) => {
      f = D(f), u = z(o, u), l && (l = z(h, l)), v && (v = z(p4, v)), L = z(w, L);
      var U = b3(f);
      q1(U, function() {
        F1(`Cannot construct ${f} due to unbound types`, [a]);
      }), Q([e, t, r], a ? [a] : [], (I) => {
        if (I = I[0], a) var T = I.va, N = T.Ga;
        else N = x1.prototype;
        I = _1(f, function(...d2) {
          if (Object.getPrototypeOf(this) !== w1) throw new y("Use 'new' to construct " + f);
          if (B.Fa === void 0) throw new y(f + " has no accessible constructor");
          var Q2 = B.Fa[d2.length];
          if (Q2 === void 0) throw new y(`Tried to invoke ctor of ${f} with invalid number of parameters (${d2.length}) - expected (${Object.keys(B.Fa).toString()}) parameters instead!`);
      ...
      o = z(a, o), Q([], [e], (l) => {
        l = l[0];
        var p4 = `constructor ${l.name}`;
        if (l.va.Fa === void 0 && (l.va.Fa = []), l.va.Fa[t - 1] !== void 0) throw new y(`Cannot register multiple constructors with identical number of parameters (${t - 1}) for class '${l.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return l.va.Fa[t - 1] = () => {
          F1(`Cannot construct ${l.name} due to unbound types`, h);
        }, Q([], h, (v) => (v.splice(1, 0, null), l.va.Fa[t - 1] = X1(p4, v, null, o, u), [])), [];
      });
    }, f: (e, t, r, a, o, u, h, l) => {
      var p4 = Y1(r, a);
      t = D(t), t = B2(t), u = z(o, u), Q([], [e], (v) => {
        function f() {
          F1(`Cannot call ${w} due to unbound types`, p4);
        }
        v = v[0];
        var w = `${v.name}.${t}`;
        t.startsWith("@@") && (t = Symbol[t.substring(2)]), l && v.va.cb.push(t);
        var L = v.va.Ga, U = L[t];
        return U === void 0 || U.ya === void 0 && U.className !== v.name && U.Ha === r - 2 ? (f.Ha = r - 2, f.className = v.name, L[t] = f) : (z2(L, t, w), L[t].ya[r - 2] = f), Q([], p4, (I) => (I = X1(w, I, v, u, h), L[t].ya === void 0 ? (I.Ha = r - 2, L[t] = I) : L[t].ya[r - 2] = I, [])), [];
      });
    }, V: (e) => H2(e, j2), x: (e, t, r, a) => {
      function o() {
      }
      t = D(t), o.values = {}, H2(e, { name: t, constructor: o, fromWireType: function(u) {
      ...
      t = D(t), H2(e, { name: t, fromWireType: (a) => a, toWireType: (a, o) => o, Ca: 8, readValueFromPointer: x3(t, r), Da: null });
    }, u: (e, t, r, a, o, u) => {
      var h = Y1(t, r);
      ...
      var h = t.includes("unsigned") ? function(l, p4) {
        return p4 >>> 0;
      } : function(l, p4) {
        return p4;
      };
      H2(e, { name: t, fromWireType: o, toWireType: h, Ca: 8, readValueFromPointer: F3(t, r, a !== 0), Da: null });
    }, h: (e, t, r) => {
      function a(u) {
      ...
      r = D(r), H2(e, { name: r, fromWireType: a, Ca: 8, readValueFromPointer: a }, { ab: true });
    }, t: (e) => {
      H2(e, A3);
    }, aa: (e, t, r, a, o, u, h, l, p4, v, f, w) => {
      r = D(r), u = z(o, u), l = z(h, l), v = z(p4, v), w = z(f, w), Q([e], [t], (L) => (L = L[0], [new g1(r, L.va, false, false, true, L, a, u, l, v, w)]));
    }, A: (e, t) => {
      t = D(t);
      var r = t === "std::string";
      H2(e, { name: t, fromWireType: function(a) {
        var o = E[a >> 2], u = a + 4;
        if (r) for (var h = u, l = 0; l <= o; ++l) {
          var p4 = u + l;
          if (l == o || x[p4] == 0) {
            if (h = h ? c1(x, h, p4 - h) : "", v === void 0) var v = h;
            else v += "\0", v += h;
            h = p4 + 1;
          }
        }
        else {
          for (v = Array(o), l = 0; l < o; ++l) v[l] = String.fromCharCode(x[u + l]);
          v = v.join("");
        }
        return X(a), v;
        ...
        if (r && h) for (var l = u = 0; l < o.length; ++l) {
          var p4 = o.charCodeAt(l);
          127 >= p4 ? u++ : 2047 >= p4 ? u += 2 : 55296 <= p4 && 57343 >= p4 ? (u += 4, ++l) : u += 3;
        }
        else u = o.length;
        if (l = s2(4 + u + 1), p4 = l + 4, E[l >> 2] = u, r && h) p1(o, p4, u + 1);
        else if (h) for (h = 0; h < u; ++h) {
          var v = o.charCodeAt(h);
          if (255 < v) throw X(p4), new y("String has UTF-16 code units that do not fit in 8 bits");
          x[p4 + h] = v;
        }
        else for (h = 0; h < u; ++h) x[p4 + h] = o[h];
        return a !== null && a.push(X, l), l;
      }, Ca: 8, readValueFromPointer: v1, Da(a) {
        X(a);
      } });
    }, s: (e, t, r) => {
      if (r = D(r), t === 2) var a = R3, o = D3, u = k3, h = (l) => u1[l >> 1];
      else t === 4 && (a = O3, o = z3, u = W3, h = (l) => E[l >> 2]);
      H2(e, { name: r, fromWireType: (l) => {
        for (var p4 = E[l >> 2], v, f = l + 4, w = 0; w <= p4; ++w) {
          var L = l + 4 + w * t;
          (w == p4 || h(L) == 0) && (f = a(f, L - f), v === void 0 ? v = f : (v += "\0", v += f), f = L + t);
        }
        return X(l), v;
      }, toWireType: (l, p4) => {
        if (typeof p4 != "string") throw new y(`Cannot pass non-string to C++ string type ${r}`);
        var v = u(p4), f = s2(4 + v + t);
        return E[f >> 2] = v / t, o(p4, f + 4, v + t), l !== null && l.push(X, f), f;
      }, Ca: 8, readValueFromPointer: v1, Da(l) {
        X(l);
      } });
    }, w: (e, t, r, a, o, u) => {
      I1[e] = { name: D(t), Oa: z(r, a), Ea: z(o, u), Ra: [] };
    }, j: (e, t, r, a, o, u, h, l, p4, v) => {
      I1[e].Ra.push({ Va: D(t), $a: r, Ya: z(a, o), Za: u, gb: h, fb: z(l, p4), hb: v });
    }, X: (e, t) => {
      t = D(t), H2(e, { jb: true, name: t, Ca: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, H: () => {
      N1 = false, i2 = 0;
      ...
      e--;
      var u = Array(e);
      return t = `methodCaller<(${a.map((h) => h.name).join(", ")}) => ${o.name}>`, $3(_1(t, (h, l, p4, v) => {
        for (var f = 0, w = 0; w < e; ++w) u[w] = a[w].readValueFromPointer(v + f), f += a[w].Ca;
        return l = r === 1 ? B3(l, u) : l.apply(h, u), h = [], l = o.toWireType(h, l), h.length && (E[p4 >> 2] = A1(h)), l;
      }));
    }, $: (e) => {
      9 < e && (Y[e + 1] += 1);
    }, Y: (e) => {
      ...
      for (var o = 0, u = 0; u < r; u++) {
        ...
        t += 8;
        for (var p4 = 0; p4 < l; p4++) {
          var v = e, f = x[h + p4], w = H3[v];
    ...
    function X2() {
      ...
      if (!(0 < t1)) {
        if (d.preRun) for (typeof d.preRun == "function" && (d.preRun = [d.preRun]); d.preRun.length; ) c3();
...
function v2(c) {
  ...
  for (let i = 0; i < W1.length; i += 1) if (W1[i] !== n[i]) return false;
  return true;
}
function a3(c) {
...
var p = ({ animationId: o, autoplay: B, backgroundColor: m, className: T, createDotLottie: E, data: s, dotLottieRefCallback: W2, loop: D, mode: d, playOnHover: b, renderConfig: y, segment: n, speed: k2, src: f, style: S, themeData: w, themeId: l, useFrameInterpolation: g3, workerId: h, ...R }) => {
  let [r, v] = (0, import_react.useState)(null), c = (0, import_react.useRef)(null), t = (0, import_react.useRef)(null), C3 = (0, import_react.useRef)(W2), P = { speed: k2, mode: d, loop: D, useFrameInterpolation: g3, segment: n, backgroundColor: m, autoplay: B, themeId: l, workerId: h, src: f, data: s, renderConfig: y }, a = (0, import_react.useRef)(P);
  C3.current = W2, t.current = r, a.current = P, (0, import_react.useEffect)(() => {
    typeof C3.current == "function" && r && C3.current(r);
  }, [r]);
  let O = (0, import_react.useCallback)((i) => {
    if (c.current = i, i) {
      let u = E({ ...a.current, canvas: i });
      v(u);
    } else r == null ? void 0 : r.destroy(), v(null);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let i = (u) => {
      var _a2, _b2;
      b && (u.type === "mouseenter" && ((_a2 = t.current) == null ? void 0 : _a2.play()), u.type === "mouseleave" && ((_b2 = t.current) == null ? void 0 : _b2.pause()));
    };
    return (_a = c.current) == null ? void 0 : _a.addEventListener("mouseenter", i), (_b = c.current) == null ? void 0 : _b.addEventListener("mouseleave", i), () => {
      var _a2, _b2;
      (_a2 = c.current) == null ? void 0 : _a2.removeEventListener("mouseenter", i), (_b2 = c.current) == null ? void 0 : _b2.removeEventListener("mouseleave", i);
    };
  }, [b]), (0, import_react.useEffect)(() => () => {
    r && (r.destroy(), v(null));
  }, [r]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setSpeed(k2 ?? 1);
  }, [k2]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setMode(d ?? "forward");
  }, [d]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setLoop(D ?? false);
  }, [D]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setUseFrameInterpolation(g3 ?? true);
  }, [g3]), (0, import_react.useEffect)(() => {
    var _a;
    typeof (n == null ? void 0 : n[0]) == "number" && typeof n[1] == "number" && ((_a = t.current) == null ? void 0 : _a.setSegment(n[0], n[1]));
  }, [n]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setBackgroundColor(m ?? "");
  }, [m]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setRenderConfig(y ?? {});
  }, [JSON.stringify(y)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof s != "string" && typeof s != "object" || ((_a = t.current) == null ? void 0 : _a.load({ data: s, ...a.current }));
  }, [s]), (0, import_react.useEffect)(() => {
    var _a;
    typeof f == "string" && ((_a = t.current) == null ? void 0 : _a.load({ src: f, ...a.current }));
  }, [f]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setMarker(R.marker ?? "");
  }, [R.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.loadAnimation(o ?? "");
  }, [o]), (0, import_react.useEffect)(() => {
    var _a;
    typeof l == "string" && ((_a = t.current) == null ? void 0 : _a.setTheme(l));
  }, [l]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setThemeData(w ?? "");
  }, [w]), (0, import_jsx_runtime.jsx)("div", { className: T, ...!T && { style: { width: "100%", height: "100%", lineHeight: 0, ...S } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: O, style: { width: "100%", height: "100%" }, ...R }) });
};
var H = (o) => new s3(o);
var Z2 = (o) => (0, import_jsx_runtime.jsx)(p, { ...o, createDotLottie: H });
var A2 = (o) => new h3(o);
var tt = (o) => (0, import_jsx_runtime.jsx)(p, { ...o, createDotLottie: A2 });
var it = (o) => {
  h3.setWasmUrl(o), s3.setWasmUrl(o);
};
export {
  Z2 as DotLottieReact,
  tt as DotLottieWorkerReact,
  it as setWasmUrl
};
