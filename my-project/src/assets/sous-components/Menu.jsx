...
export  const Menu= ({menu,showMenu}) => (
  ...
  <div className=" lg:flex  px-10 py-3 lg:items-center gap-24 dark:bg-white">
  ...
  <li className='group max-lg:border-b max-lg:px-3 max-lg:py-3 lg:py-2 relative'>
    ...
    <ul
      className='absolute top-12 max-lg:top-8 left-0 z-50 block space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[250px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
      <li className='border-b py-3'>
        <a href='.'
          className='hover:text-gray-900 hover:fill-[000] text-gray-600 font-semibold text-[15px] block'>
...
<div className="mt-2 ">
  <div className="relative flex items-center rounded-md  dark:bg-white bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-gray-900">
    ...
    <input
      ...
      name="price"
      id="price"
      className=" dark:bg-white  w-full block lg:w-[300px] grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
    />
    ...
    <div className="grid shrink-0 grid-cols-1 focus-within:relative lg:w-[80px] border">
      <select
        ...
        name="currency"
        aria-label="Currency"
        className=" dark:bg-white col-start-1 row-start-1 w-full appearance-none rounded-md py-1.5 pl-3 pr-7 text-base text-gray-500 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-900 sm:text-sm/6"
      >
        <option>All</option>
        <option>CAD</option>
        <option>EUR</option>
