      ...
      <div className="  rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 z-10">
        ...
        <div className="pt-6">
          ...
          <div className="mt-4 flex items-center justify-between gap-4">
            <span className="text-xl font-semibold text-gray-900 dark:text-white flex gap-1 items-center ">{product.price}<span>DH</span></span>
            <button className="rounded-lg bg-gray-500 hover:bg-gray-500/90 px-4 py-2 text-white">Add to Cart</button>
          </div>
        </div>
      </div>
    );
