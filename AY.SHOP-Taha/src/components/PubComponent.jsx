import CarouselProducts from "./CarourselProducts";
    ...
    <div className="flex md:flex-row flex-col w-full gap-4 lg:gap-6 px-4 md:h-[50vh] lg:h-[60vh]">
      ...
      <div className="lg:block md:w-2/12 relative">
        <img
          ...
          width="200"
          height="320"
          className="w-full h-80 md:h-full object-cover rounded-lg shadow-md"
          alt="Publicité droite"
        />
        <div className="absolute md:bottom-32 lg:bottom-28 bottom-10 w-full">
          <button className="group relative block mx-auto">
            <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 opacity-75 blur transition duration-300 group-hover:opacity-100" />
            <span className="h-12 md:w-28 lg:w-full relative flex justify-center items-center gap-3 rounded-lg bg-black px-7 py-3 leading-none">
              <span className="inline-block h-3 w-3 rounded-full bg-gradient-to-tr from-cyan-500 to-blue-500 opacity-80 shadow-lg shadow-cyan-500/50 transition-all duration-300 group-hover:scale-125" />
